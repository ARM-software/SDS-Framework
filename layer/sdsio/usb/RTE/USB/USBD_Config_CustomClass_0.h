...
//         <i>https://www.usb.org/defined-class-codes.
...
//       <e>Endpoint
//       <i>Enable Endpoint for this interface.
#define USBD_CUSTOM_CLASS0_IF0_EP2_EN                              0
...
//           <3=>Interrupt
//           <1=>Isochronous
#define USBD_CUSTOM_CLASS0_IF0_EP2_BMATTRIBUTES                    0x03
...
//           <0=>OUT
//           <1=>IN
#define USBD_CUSTOM_CLASS0_IF0_EP2_BENDPOINTADDRESS                0x02
...
//               <i>For Interrupt Endpoint set value to 1 .. 255 (polling interval).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP2_FS_BINTERVAL                    1
...
//                 <1=>1 additional
//                 <2=>2 additional
#define USBD_CUSTOM_CLASS0_IF0_EP2_HS_WMAXPACKETSIZE               1024
...
//               <i>For Interrupt Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
//               <i>For Isochronous Endpoint set value to 1 .. 16 (polling interval is 2^(value-1)).
#define USBD_CUSTOM_CLASS0_IF0_EP2_HS_BINTERVAL                    1
...
#define USBD_CUSTOM_CLASS0_IF0_STR_RAW                             "USB_CUSTOM_CLASS0_IF0"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP0_NAME_RAW               "DeviceInterfaceGUID"

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP0_DATA_STR_RAW           "{7D9ADCFC-E570-4B38-BF4E-8F81F68964E0}"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP1_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP1_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP2_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP2_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP3_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF0_OS_EXT_PROP3_DATA_STR_RAW           ""
...
//         <s.126>Interface String
#define USBD_CUSTOM_CLASS0_IF1_STR_RAW                             "USB_CUSTOM_CLASS0_IF1"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP0_NAME_RAW               "DeviceInterfaceGUID"

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP0_DATA_STR_RAW           "{7D9ADCFC-E570-4B38-BF4E-8F81F68964E0}"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP1_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP1_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP2_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP2_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP3_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF1_OS_EXT_PROP3_DATA_STR_RAW           ""
...
//         <s.126>Interface String
#define USBD_CUSTOM_CLASS0_IF2_STR_RAW                             "USB_CUSTOM_CLASS0_IF2"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP0_NAME_RAW               "DeviceInterfaceGUID"

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP0_DATA_STR_RAW           "{7D9ADCFC-E570-4B38-BF4E-8F81F68964E0}"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP1_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP1_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP2_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP2_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP3_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF2_OS_EXT_PROP3_DATA_STR_RAW           ""
...
//         <s.126>Interface String
#define USBD_CUSTOM_CLASS0_IF3_STR_RAW                             "USB_CUSTOM_CLASS0_IF3"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP0_NAME_RAW               "DeviceInterfaceGUID"

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP0_DATA_STR_RAW           "{7D9ADCFC-E570-4B38-BF4E-8F81F68964E0}"
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP1_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP1_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP2_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP2_DATA_STR_RAW           ""
...
//           <s.512>Name
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP3_NAME_RAW               ""

//           <h>Data
//             <s.1024>Unicode String
//             <i>Property Data in case Data Type is selected as Unicode String.
#define USBD_CUSTOM_CLASS0_IF3_OS_EXT_PROP3_DATA_STR_RAW           ""
