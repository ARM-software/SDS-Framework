...
/* Configure SPI peripheral number used for communication with WiFi module */
#ifndef MX_WIFI_SPI_NUM
#define MX_WIFI_SPI_NUM                                                     (2)
#endif /* MX_WIFI_SPI_NUM */
...
/* #define MX_WIFI_SPI_DEBUG */

/* Helper macros used for removing parenthesis around macro values */ 
#define MX_WIFI_REMOVE_PARENTHESES(x)   MX_WIFI_REMOVE_(MX_WIFI_PARENTHESES_ x)
#define MX_WIFI_PARENTHESES_(...)       MX_WIFI_PARENTHESES_ __VA_ARGS__
#define MX_WIFI_REMOVE_(...)            MX_WIFI_REMOVE__(__VA_ARGS__)
#define MX_WIFI_REMOVE__(...)           MX_WIFI_REMOVE_ ## __VA_ARGS__
#define MX_WIFI_REMOVE_MX_WIFI_PARENTHESES_

/* Create MXCHIP_SPI macro used by mx_wifi_spi.c module */ 
#define MXCHIP_SPI__(num)       hspi##num
#define MXCHIP_SPI_(num)        MXCHIP_SPI__(num)
#define MXCHIP_SPI              MXCHIP_SPI_(MX_WIFI_REMOVE_PARENTHESES(MX_WIFI_SPI_NUM))

/* Create DMA_ON_USE macro used by mx_wifi_spi.c module */ 
#define DMA_ON_USE              MX_WIFI_SPI_DMA
