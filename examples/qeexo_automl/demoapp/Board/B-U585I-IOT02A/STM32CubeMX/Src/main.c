...
//  BSP_MOTION_SENSOR_Init(1U, MOTION_MAGNETO);
  ...
  ISM330DHCX_ACC_SetFullScale(&ISM330DHCX_Obj, ISM330DHCX_4g);
  ISM330DHCX_ACC_SetOutputDataRate(&ISM330DHCX_Obj, 416.0f);
  ISM330DHCX_FIFO_ACC_Set_BDR(&ISM330DHCX_Obj, 416.0f);

  ISM330DHCX_GYRO_SetFullScale(&ISM330DHCX_Obj, ISM330DHCX_500dps);
  ISM330DHCX_GYRO_SetOutputDataRate(&ISM330DHCX_Obj, 416.0f);
  ISM330DHCX_FIFO_GYRO_Set_BDR(&ISM330DHCX_Obj, 416.0f);
