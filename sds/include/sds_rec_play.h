...
/**
  ...
  \return      return code (see \ref SDS_Recorder_Player_Error_Codes)
*/
...
/**
  ...
  \return      number of data bytes written, or 0 if operation failed
*/
...
/**
  ...
  \param[in]   id             \ref sdsRecPlayId_t handle to SDS Recorder/Player stream
  \return      number of bytes in next available data block, or 0 if operation failed
*/
...
/**
  ...
  \param[in]   id             \ref sdsRecPlayId_t handle to SDS Recorder/Player stream
  \return      non-zero if end of stream, or 0 otherwise
*/
